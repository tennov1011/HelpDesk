...
{:else}
	...
	>
		...
		<div class="bg-white p-4 rounded-xl shadow-lg mb-6 animate-fade-in-up">
			<TicketList tickets={filteredTickets} isAdmin={true} on:deleted={fetchTickets} />
		</div>
...
{#if showDetailModalTicket && selectedTicket}
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
		<div
			class="bg-gradient-to-br from-blue-50 via-white to-blue-100 border border-blue-200 rounded-2xl shadow-4xl p-8 max-w-6xl w-full h-[70vh] overflow-y-auto relative animate-fade-in-up"
		>
			<button
